        ...
        <ul>
          {
            listFavorites.map((item: any) => (
             ...
             key={item.id}>
                ...
                <Label type="p" pointer={true} onClick={() => setTodoTitle(item.title)} center={true}>
                  {item.title}
                </Label>
             </li>
            ))
  ...
  const renderTimerModal = () => {
    return(
      ...
      >
        ...
        }>{editTodo.done ? "Cancel" : 'Done'}</Button>
        ADD TO FAVORITES?:
        <Button width={150} onClick={
          () =>  setEditTodo({
            id: editTodo.id,
        ...
        }>{editTodo.favorites ? "Cancel" : 'Add'}</Button>
        <Button width={250} theme="success" onClick={() => {
          updateTodoList()
        }}>
          Update List
        </Button>
    ...
    <Layout>
      <Section>
        ...
        <StyledPomodoroDiv position="left">
          ...
          <Label type="p">shift + p (Play)</Label><br/>
          <Label type="p">shift + a (Auto)</Label><br/>
          <Label type="p">shift + r (Reset)</Label><br/>
        </StyledPomodoroDiv>
